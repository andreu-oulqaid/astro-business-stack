...
export const es: TranslationKeys = {
  ...
  liveDemo: {
    ...
    challengeRunning: 'Procesando verificación…',
    captchaFailed: 'La verificación de seguridad falló. Inténtalo de nuevo.',
    captchaRequired: 'Se requiere verificación de seguridad. Actualiza e inténtalo de nuevo.',
    terminal: {
      idle: 'Añade un lead para ver la salida del pipeline.',
      checkingQuota: '◐ Comprobando ejecuciones/h y seguridad…',
      quotaOk: '✔ Cuota y seguridad OK',
      quotaDenied: '✘ Límite de ejecuciones superado',
