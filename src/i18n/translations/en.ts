...
export const en = {
  ...
  liveDemo: {
    ...
    failed: 'Failed',
    avgCaptureTime: 'Avg capture time',
    ...
    challengeRunning: 'Processing challenge…',
    captchaFailed: 'Security check failed. Try again.',
    captchaRequired: 'Security check required. Refresh and try again.',
    terminal: {
      idle: 'Add a lead to see pipeline output.',
      checkingQuota: '◐ Checking runs/h & security…',
      quotaOk: '✔ Quota & security OK',
      quotaDenied: '✘ Rate limit exceeded',
      received: 'Lead received: {lead}',
      validatingInput: '◐ Validating input…',
      validateOk: 'Input validated',
